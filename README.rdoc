...
<<<<<<< HEAD
- http://around-me.heroku.com/landmarks.json?update - updates landmark's data (events' data not included)
- http://around-me.heroku.com/landmarks.json?update&events - updates landmark's data (events' data included) - use with caution! can take a while to update all the events of that landmark!
=======
...
>>>>>>> a6a6d2503a902c19a1b42166a3e5279d4eaef7b8
